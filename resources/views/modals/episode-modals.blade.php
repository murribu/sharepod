    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">@{{episodeGroups.show ? episodeGroups.show.name : ''}}<br>@{{selectedEpisode.name}}</h4>
            </div>
...
<div class="modal fade" id="modal-archive-result" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal" aria-hidden="true">&times;</button>
